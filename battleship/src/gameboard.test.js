...
describe("Gameboard class", () => {
  ...
  test("addShip()", () => {
    ...
    expect(gameboard.board[0][0].value).toBe("ship");
    expect(gameboard.board[0][1].value).toBe("ship");
    expect(gameboard.board[0][2].value).toBe("ship");
    expect(gameboard.board[0][3].value).toBe("ship");
    expect(gameboard.board[0][4].value).toBe("ship");

    const battleship = new Ship(4);
    gameboard.addShip(battleship, 2, 6, "horizontal");
    expect(gameboard.board[2][6].value).toBe("ship");
